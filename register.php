    ...
    <section class="sign-in">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="register-form col-12 col-md-6 px-5">

                    <h2 class="text-center mb-4 pt-3"> Registration </h2>
                    ...
                    <form action="dbConnect.php" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="username" name="username" placeholder="Write Your User Name" required>
                        </div>

                        <!-- Email -->
                        <div class="mb-3">
                            <label for="email" class="form-label">Email</label>
                            <input type="email" class="form-control" id="email" name="email" placeholder="Write Your E-mail" required>
                        </div>
                        ...
                        <!-- Register Button -->
                        <button type="submit" class="btn btn-primary w-100 my-4" value="Sign Up" name="signUp">Register</button>
                    </form>

                    <div class="clik-sign py-2 ps-2">
                        <h6> Already have an account? <a href="signin.php"> Sign in </a></h6>
                    </div>

                </div>

                <div class="company-brand col-12 col-md-6 pt-5">
                    <img src="image/company-logo.png" alt="company logo" class="mx-auto d-block pt-0 pt-md-5">
